...
// const textProcessingFunc = require('../Scrape - Clean functions/Text-processing')
const dateFunc = require('./date_util_functions')
...
//     db.once('open', ()=>{console.log(chalk.redBright('Connection Successful'))})
//     return db
// }
...
module.exports = {
    ...
    getCelebInfoFromDB:getCelebInfoFromDB
}